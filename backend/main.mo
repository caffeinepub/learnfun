...
actor {
  ...
  public query ({}) func getEncouragementMessage(level : Nat, language : Language) : async Text {
    ...
    let spanishMessages = [
      "¡Muy bien! Completaste el nivel " # level.toText() # ".",
      "¡Sigue así, vas muy bien!",
      "¡Genial! Puedes lograr aún más.",
      "¡Fantástico! Tus habilidades siguen mejorando.",
      "Sigue experimentando, así aprenderás cosas nuevas.",
      "Con cada nivel te vuelves más fuerte, ¡no pares!",
      "¡Mira lo lejos que has llegado! No dejes de intentarlo, lo estás haciendo increíble.",
      "Ya has avanzado mucho. ¡Anímate a explorar cosas nuevas!",
      "Algunos niveles pueden ser difíciles, pero sigue intentando, ¡puedes lograrlo!",
      "No tengas miedo de equivocarte, ¡así es como mejoramos!",
      "Las cosas nuevas pueden parecer difíciles al principio, pero seguir intentando te ayudará.",
      "Cada vez que completas un nivel, desarrollas nuevas habilidades.",
      "Los errores son una señal de crecimiento, sigue aprendiendo.",
      "Si no sale bien a la primera, ¡no te preocupes! La clave es seguir practicando.",
      "Los desafíos te hacen crecer, ¡no te rindas!",
    ];
    ...
    let frenchMessages = [
      ...
      "Excellent! Tu deviens un vrai pro!",
      "Continue d'essayer pour découvrir de nouvelles choses!",
      "À chaque niveau, tu deviens plus fort, continue ainsi!",
      "Regarde le chemin parcouru! Continue comme ça, c'est super!",
      "Tu as déjà bien progressé. N'hésite pas à essayer de nouvelles choses!",
      "Certains niveaux peuvent être plus difficiles, mais continue d'essayer!",
      "N’aie pas peur de te tromper, c’est comme cela qu’on apprend.",
      "Les nouvelles choses peuvent paraître dures au début, mais avec la pratique, cela deviendra facile!",
      "À chaque nouveau niveau accompli, tu gagnes de l’expérience.",
      "Les erreurs montrent que tu progresses, continue ainsi!",
      "Ce n'est pas grave de ne pas réussir du premier coup, continue à t’exercer!",
      "Les difficultés nous aident à grandir, ne t’arrête pas!",
    ];

    let germanMessages = [
      "Super! Du hast Level " # level.toText() # " gemeistert!",
      "Du machst das großartig!",
      "Klasse! Du schaffst noch viel mehr!",
      "Wunderbar! Deine Fähigkeiten werden immer besser.",
      "Probiere immer wieder Neues aus – so lernst du am schnellsten.",
      "Mit jeder neuen Stufe wirst du stärker, weiter so!",
      "Sieh, wie weit du schon gekommen bist! Gib nicht auf – das ist wirklich toll.",
      "Du hast schon viel geschafft. Trau dich ruhig, mal etwas Neues zu probieren!",
      "Manche Level sind etwas schwerer, aber gib nicht auf!",
      "Habe keine Angst vor Fehlern – so lernst du am besten!",
      "Am Anfang kann alles ungewohnt oder schwer wirken – aber wenn du weiter übst, klappt es bestimmt!",
      "Immer, wenn du eine Stufe meisterst, baust du wertvolle neue Fähigkeiten auf.",
      "Jeder Fehler ist ein Fortschritt – übe immer weiter!",
      "Es ist in Ordnung, wenn es beim ersten Mal nicht klappt – nur nicht aufgeben.",
      "Herausforderungen helfen uns zu wachsen. Du kannst das schaffen!",
    ];
    ...
    let languageMessages = switch (language) {
      ...
      case (#spanish) { spanishMessages };
      case (#french) { frenchMessages };
      case (#german) { germanMessages };
